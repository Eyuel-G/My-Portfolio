      ...
      <div className="relative bg-primary/40 backdrop-blur-md rounded-[32px] overflow-hidden
        ...
        <div className="relative grid md:grid-cols-2 gap-0">
          ...
          <div className="relative h-[400px] md:h-[500px] overflow-hidden group">
            ...
            <div className="absolute top-6 right-6 flex gap-3 z-20">
              <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="w-12 h-12 rounded-full bg-primary/80 backdrop-blur-md
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.1, rotate: -5 }}
                whileTap={{ scale: 0.9 }}
                className="w-12 h-12 rounded-full bg-blueAccent/80 backdrop-blur-md
              ...
              >
                <img src={pineapple} alt="demo" className="w-6 h-6" />
              </motion.a>
            </div>
          </div>
          ...
          <div className="relative p-8 md:p-10 flex flex-col justify-center">
            ...
            >
              {/* Project number */}
              <div className="text-blueAccent/40 text-[14px] font-bold font-poppins mb-2 
              tracking-wider">
                FEATURED PROJECT
              </div>

              {/* Title */}
              <h3 className="text-white text-[36px] md:text-[42px] font-bold font-beckman mb-4
                leading-tight bg-gradient-to-r from-white to-blueLight bg-clip-text text-transparent">
                {name}
              </h3>
              
              {/* Description */}
              <p className="text-white-100/80 text-[16px] leading-relaxed mb-6">
                {description}
              </p>
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                {tags?.map((tag, idx) => (
                  <motion.span
                    ...
                    className={`px-4 py-2 text-[13px] font-semibold rounded-full
...
const Projects = () => {
  ...
  return (
    <div className="relative w-full max-h-screen flex flex-col justify-center">
      {/* Section Header */}
      ...
      >
        ...
        <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 flex justify-between px-4 pointer-events-none">
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={() => paginate(-1)}
            className="w-14 h-14 rounded-full bg-primary/80 backdrop-blur-md
